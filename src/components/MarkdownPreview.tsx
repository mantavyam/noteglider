...
const MarkdownPreview: React.FC<MarkdownPreviewProps> = ({ file }) => {
    ...
    return (
      <div className="h-full flex items-center justify-center">
        <div className="animate-pulse-subtle">
          <svg className="animate-spin-slow w-8 h-8 text-blue-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
  ...
  return (
    <motion.div
      ...
      className="prose prose-sm max-w-none p-6 bg-white rounded-lg shadow-sm border"
    >
      <ReactMarkdown
