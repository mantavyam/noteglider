                      ...
                      <form className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div className="space-y-2">
                            ...
                            <Input id="name" defaultValue="Shivam Singh" className="bg-zinc-700 border-zinc-600" />
                          </div>
                          <div className="space-y-2">
                            <Label htmlFor="email">Email Address</Label>
                            <Input id="email" type="email" defaultValue="studios@mantavyam.com" className="bg-zinc-700 border-zinc-600" />
                          </div>
                        </div>
                        <div className="space-y-2">
                          <Label htmlFor="company">Company Name</Label>
                          <Input id="company" defaultValue="Mantavyam India" className="bg-zinc-700 border-zinc-600" />
                        </div>
                      </form>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-4">
                        <div className="p-4 bg-zinc-700 rounded-md flex items-center justify-between">
                          <div>
                            <h4 className="font-medium">Learning Niti</h4>
                            <p className="text-sm text-zinc-400">Kapil K - learningnit@gmail.com</p>
                          </div>
                          <Button variant="outline" className="bg-zinc-600 border-zinc-500">Edit</Button>
                        </div>
                        <div className="p-4 bg-zinc-700 rounded-md flex items-center justify-between">
                          <div>
                            <h4 className="font-medium">Yes Officers</h4>
                            <p className="text-sm text-zinc-400">Kush P - pandey.22k@gmail.com</p>
                          </div>
                          <Button variant="outline" className="bg-zinc-600 border-zinc-500">Edit</Button>
                        </div>
                        <div className="p-4 bg-zinc-700 rounded-md flex items-center justify-between">
                          <div>
                            <h4 className="font-medium">Mantavyam Studios</h4>
                            <p className="text-sm text-zinc-400">Shivam S - studios@mantavyam.com</p>
                          </div>
                          <Button variant="outline" className="bg-zinc-600 border-zinc-500">Edit</Button>
                        </div>
                      </div>
